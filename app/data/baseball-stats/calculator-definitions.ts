...
export const calculatorDefinitions: Record<string, CalculatorDefinition> = {
  "batting-average": {
    ...
    title: "打率計算ツール",
    metaTitle:
      "打率計算ツール【登録不要・無料】｜安打数と打数を入力→打率を瞬時に自動計算",
    metaDescription:
      "安打数と打数を入力するだけで打率を自動計算。打率の出し方・計算方法も解説。高校野球・プロ野球の目安値付き。登録不要・完全無料で使える計算ツール。",
    heading: "打率計算ツール｜打率の出し方・計算方法",
    description:
  ...
  era: {
    ...
    formulaExample:
      "例：7投球回で自責点2の場合、防御率 = 2 × 9 ÷ 7 = 2.57（60投球回で自責点12なら 12 × 9 ÷ 60 = 1.80）",
    guide: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "投球回は1/3イニング単位で記録されます。たとえば「5回1アウト」まで投げた場合は5 1/3イニング（5.1と表記）、「5回2アウト」は5 2/3イニング（5.2と表記）です。防御率の計算では、5.1は16/3（約5.333）、5.2は17/3（約5.667）として計算します。このツールは入力値をそのまま投球回として使うため、5回1/3なら5.33、5回2/3なら5.67のように小数で入力してください。",
      },
      {
  ...
  ops: {
    ...
    faq: [
      ...
      },
      {
        question: "良いOPSの目安は？",
        answer:
          "NPB（日本プロ野球）では.800以上で優秀、.900以上は強打者、1.000を超えるとリーグを代表するレベルです。リーグ平均は歴史的に.700前後とされてきましたが、近年は.660〜.700まで低下しています。MLBでもほぼ同様の基準で評価されます。",
      },
      {
      ...
      },
      {
        ...
        answer:
          "NPBのリーグ全体の平均OPSはシーズンによって変動しますが、近年（2021〜2023）は.660〜.700のレンジまで低下しています。タイトル争いをする強打者は.900〜1.000程度、MVP級の活躍では1.000を超えることもあります。MLB（メジャーリーグ）のリーグ平均は概ね.700〜.730の範囲です。",
      },
      {
        question: "OPSと打率の違いは？",
        answer:
  ...
  "k-bb": {
    ...
    title: "K/BB計算ツール",
    metaTitle:
      "K/BB計算ツール｜奪三振80・与四球20なら4.00。数値を入れるだけで自動計算【無料】",
    metaDescription:
      "奪三振と与四球を入力するだけでK/BB（奪三振÷与四球）を自動計算。3.00以上で優秀、5.00以上でリーグトップ級などNPB・高校野球の目安と、K/9・BB/9との違いも解説。登録不要・無料。",
    heading: "K/BB計算ツール",
    description:
  ...
  "winning-percentage": {
    ...
    heading: "勝率計算ツール",
    description:
      "勝利数と敗北数を入力して、勝率を計算できます。勝率はチームや投手の勝敗成績を示す基本的な指標です。",
    explanation:
      "勝率（Winning Percentage / WPCT）は、勝利数を試合数（勝利数＋敗北数）で割った値で、チームや投手がどれだけの割合で勝利しているかを示す、野球で最も基本的な成績指標の一つです。プロ野球（NPB・MLB）ではペナントレースの順位決定に直結する重要な数値であり、高校野球やアマチュア野球でもチーム力の比較に広く用いられています。\n\n勝率の計算式は「勝利数 ÷（勝利数 + 敗北数）」とシンプルです。ただし、引き分けの扱いはリーグによって異なります。NPB（日本プロ野球）では2001年以降、引き分けを除外して勝率を算出しています。つまり引き分けは勝率の計算に含まれず、勝ちと負けの比率のみで順位が決まります。一方、MLB（メジャーリーグ）では延長戦の末に必ず決着をつけるため、基本的に引き分けは発生しません。\n\n勝率.600以上であれば優勝争いに絡むレベル、.500（5割）がちょうど勝敗五分の基準です。NPBのペナントレースでは勝率.550〜.580程度で優勝するシーズンもあれば、.600を大きく超える圧倒的な強さで制するシーズンもあります。.400を下回るとBクラス（下位）に沈むことが多く、シーズン通算で.350未満になることは稀です。\n\n投手個人の勝率も同様の計算式で算出され、先発投手の安定感を示す指標として用いられます。ただし、投手の勝敗は打線の援護や救援投手の成績にも左右されるため、投手の実力を正確に評価するには防御率やWHIPなどの指標と併用することが重要です。最高勝率のタイトルは規定勝利数（NPBでは13勝以上）を満たした投手の中で最も高い勝率を記録した投手に与えられます。",
    formula: "勝率 = 勝利数 ÷（勝利数 + 敗北数）",
    formulaExample:
      "例：80勝60敗の場合、勝率 = 80 ÷（80 + 60）= 80 ÷ 140 = .571",
    guide: [
      { label: ".600以上", description: "優勝争いレベル" },
      { label: ".500〜.599", description: "勝ち越し（Aクラス圏内）" },
      { label: ".500", description: "勝敗五分" },
      { label: ".400〜.499", description: "負け越し（Bクラス）" },
      { label: ".400未満", description: "下位に低迷" },
    ],
    fields: [
      {
        name: "wins",
    ...
    faq: [
      {
        question: "勝率とは何ですか？",
        answer:
          "勝率（Winning Percentage / WPCT）は、勝利数を試合数（勝利数＋敗北数）で割った値で、チームや投手がどれだけの割合で勝利しているかを示す指標です。プロ野球のペナントレースの順位決定に直結する重要な数値であり、高校野球やアマチュア野球でもチーム力の比較に広く用いられています。",
      },
      {
        question: "勝率の計算方法は？",
        answer:
          "勝率 = 勝利数 ÷（勝利数 + 敗北数）で計算します。たとえば80勝60敗の場合、80 ÷ 140 = .571 となります。小数第3位まで表記するのが一般的です。引き分けはNPBでは計算に含めません。",
      },
      {
        question: "プロ野球の勝率の目安は？",
        answer:
          "NPB（日本プロ野球）では勝率.600以上で優勝争いレベル、.500〜.599が勝ち越し（Aクラス圏内）、.500がちょうど五分、.400〜.499が負け越し（Bクラス）とされます。優勝チームの勝率はシーズンによって.550〜.650程度まで幅があります。",
      },
      {
        question: "引き分けは勝率にどう影響しますか？",
        answer:
          "NPB（日本プロ野球）では2001年以降、引き分けを除外して勝率を算出しています。つまり勝率の計算式は「勝利数 ÷（勝利数 + 敗北数）」であり、引き分け試合は分母にも分子にも含まれません。MLB（メジャーリーグ）では延長戦で必ず決着をつけるため、基本的に引き分けは発生しません。",
      },
      {
        question: "投手の勝率はどう計算する？",
        answer:
          "投手個人の勝率もチームと同じ計算式（勝利数 ÷（勝利数 + 敗北数））で算出されます。最高勝率のタイトルはNPBでは規定勝利数（13勝以上）を満たした投手に与えられます。ただし投手の勝敗は打線の援護や救援投手の成績にも左右されるため、実力評価には防御率やWHIPとの併用が重要です。",
      },
    ],
  ...
  "opponent-batting-average": {
    ...
    title: "被打率計算ツール",
    metaTitle:
      "被打率計算ツール｜被安打30・打数120なら.250。被安打と打数を入れるだけ【無料】",
    metaDescription:
      "被安打と打数（対戦打者の打数）を入力するだけで被打率を自動計算。被安打率との違い、.220未満でエース級などNPB・高校野球の目安、WHIP・防御率との使い分けも解説。登録不要・無料。",
    heading: "被打率計算ツール",
    description:
      "被安打と対戦打者の打数を入力して、被打率を計算できます。被打率は投手がどれだけ打たれにくいかを示す指標です。",
    explanation:
      "被打率（ひだりつ / Opponent Batting Average）は、投手が対戦した打者にどれだけの割合で安打を許したかを示す指標です。打者の打率を投手の側から見たもので、「被安打率」と呼ばれることもあります。値が低いほど打たれにくい投手で、防御率・WHIPと並んで投手の支配力を測る基本指標として、プロ野球（NPB・MLB）から高校野球まで広く使われています。\n\n計算式は「被安打 ÷ 打数」です。ここでいう打数は対戦した打者の打数で、打者の打率と同じルールで数えます。つまり四球・死球・犠打・犠飛・打撃妨害は打数に含めません。「対戦打者数（打席数）」で割ると値が小さく出てしまうため、スコアブックから集計するときは四死球と犠打・犠飛を除いた数を使ってください。\n\nNPB（日本プロ野球）のリーグ全体の被打率はおおむね.245〜.260で推移しています。被打率.220未満ならエース級、.220〜.249は優秀、.250〜.269が平均的な水準です。.290を超えると被安打が多く、失点につながりやすい状態といえます。高校野球は金属バットの影響で全体に打高となるため、プロより被打率が高めに出る傾向があり、.250以下なら地区大会で上位を狙えるエース級の目安です。\n\n被打率には限界もあります。四球を許しても被打率は悪化しないため、制球に課題のある投手を過大評価しやすい点には注意が必要です。四球を含めた走者の許容率を見るにはWHIP、実際の失点を見るには防御率を併用します。また、インプレーになった打球が安打になる割合（BABIP）は守備力や運にも左右されるため、短い期間の被打率は上下しやすい点も覚えておくと、数値をより正しく読めます。",
    formula: "被打率 = 被安打 ÷ 打数（対戦打者の打数）",
    ...
    calculate: (values: Record<string, number>) => {
      const { hitsAllowed, atBats } = values;
      if (!atBats || atBats === 0) return null;
      if (hitsAllowed > atBats) return null;
      return hitsAllowed / atBats;
    },
    faq: [
      {
        question: "被打率とは何ですか？",
        answer:
          "被打率（Opponent Batting Average）は、投手が対戦した打者にどれだけの割合で安打を許したかを示す指標です。打者の打率を投手側から見たもので、値が低いほど打たれにくい投手とされます。防御率・WHIPと並ぶ投手評価の基本指標です。",
      },
      {
        question: "被打率の計算方法は？",
        answer:
          "被打率 = 被安打 ÷ 打数 で計算します。たとえば打数120で被安打30なら、30 ÷ 120 = .250 です。打数は打者の打率と同じく、四球・死球・犠打・犠飛・打撃妨害を除いた数を使います。",
      },
      {
        question: "被打率と被安打率の違いは？",
        answer:
          "多くの場合は同じ指標を指し、公式記録では「被打率」と表記されます。ただし「被安打率」は、奪三振率（K/9）や与四球率（BB/9）と同じ 9 イニング換算の指標（被安打 × 9 ÷ 投球回）を指して使われることもあります。このツールが計算するのは 被安打 ÷ 打数 の被打率です。",
      },
      {
        question: "打数と対戦打者数（打席数）の違いは？",
        answer:
          "対戦打者数はその投手と対戦したすべての打席の数で、四球・死球・犠打・犠飛も含みます。打数はそこから四死球・犠打・犠飛・打撃妨害を除いた数です。被打率の分母には打数を使うため、対戦打者数で割ると実際より低い値になってしまいます。",
      },
      {
        question: "良い被打率の目安は？",
        answer:
          "プロ野球（NPB）では.220未満がエース級、.220〜.249が優秀、.250〜.269が平均的とされます。リーグ全体の被打率はおおむね.245〜.260で推移しています。.290を超えると被安打が多く、失点につながりやすい水準です。",
      },
      {
        question: "高校野球の被打率の目安は？",
        answer:
          "高校野球は金属バットの影響で打高になりやすく、プロより被打率が高めに出ます。.250以下なら地区大会で上位を狙えるエース級、.300前後が平均的な目安です。相手チームのレベル差で大きく変動するため、複数試合の合計で見るのがおすすめです。",
      },
      {
        question: "被打率とWHIP・防御率の違いは？",
        answer:
          "被打率は安打だけを見る指標で、四球を許しても悪化しません。WHIPは（与四球 + 被安打）÷ 投球回で、四球を含めた走者の許容率を示します。防御率は実際に許した自責点を9イニング換算した値です。被打率が低くてもWHIPが高い投手は四球が多いタイプ、被打率が低く防御率も低ければ安定して抑えている投手といえます。",
      },
    ],
    relatedSlugs: ["era", "whip", "k-bb"],
    cta: {
      heading: "被打率を記録して、打たれにくさを数値で確認しよう",
      body: "BUZZ BASEアプリなら試合結果を入力するだけで被打率を含む全投手指標を自動算出。チームメイトとランキング形式で成績を共有できます。完全無料。",
    },
  },
  "risp-batting-average": {
    ...
    title: "得点圏打率計算ツール",
    metaTitle:
      "得点圏打率計算ツール｜40打数12安打なら.300。安打数と打数を入れるだけ【無料】",
    metaDescription:
      "得点圏（二塁・三塁に走者）での安打数と打数を入力するだけで得点圏打率を自動計算。得点圏の定義、.300で勝負強いなどNPB・高校野球の目安、通常の打率との違いも解説。登録不要・無料。",
    heading: "得点圏打率計算ツール",
    description:
      "得点圏での安打数と打数を入力して、得点圏打率を計算できます。得点圏打率はチャンスでどれだけ安打を打てたかを示す指標です。",
    explanation:
      "得点圏打率（とくてんけんだりつ / Batting Average with RISP）は、得点圏に走者がいる場面に限った打率です。分子はその場面での安打数、分母はその場面での打数で、計算式そのものは通常の打率と変わりません。中継やスポーツ紙で「チャンスに強い打者」を語るときによく使われる指標です。\n\n得点圏とは、二塁または三塁に走者がいる状況を指します。単打が出れば生還が期待できる位置という意味で、走者二塁・三塁・二三塁・一二塁・一三塁・満塁はすべて得点圏です。走者が一塁だけの場面や無走者の場面は含みません。打数の数え方は通常の打率と同じで、四球・死球・犠打・犠飛・打撃妨害は分母から除きます。そのため、チャンスで敬遠された打席や犠牲フライで打点を挙げた打席は、得点圏打率には反映されません。\n\nNPB（日本プロ野球）のリーグ全体の得点圏打率はおおむね.245〜.260で、通常の打率とほぼ同じ水準です。個人では.300以上なら勝負強い打者、.350以上はリーグ上位に入る数字です。逆に.200を下回るとチャンスで結果が出ていない状態といえます。高校野球は金属バットの影響で全体に数字が高く出るため、プロの目安よりやや高めに見るのが実態に合います。\n\n注意したいのは、得点圏打率は打数が少なくブレが大きい指標だという点です。シーズン通してでも得点圏の打数は全打数の2〜3割程度で、単年の得点圏打率と翌年の得点圏打率の相関は小さいとされています。単年の数字だけで「勝負強い・弱い」と断定せず、通常の打率やOPSと併せて、複数シーズンの傾向として見るのが適切です。",
    formula: "得点圏打率 = 得点圏での安打数 ÷ 得点圏での打数",
    formulaExample:
      "例：得点圏で40打数12安打の場合、得点圏打率 = 12 ÷ 40 = .300",
    guide: [
    ...
    faq: [
      {
        question: "得点圏打率とは何ですか？",
        answer:
          "得点圏打率は、二塁または三塁に走者がいる場面に限った打率です。その場面での安打数を、その場面での打数で割って算出します。チャンスでどれだけ安打を打てたかを示す指標として、プロ野球の中継やスポーツ紙で広く使われています。",
      },
      {
        question: "得点圏とはどこに走者がいる状況ですか？",
        answer:
          "二塁または三塁に走者がいる状況です。単打で生還が期待できる位置という意味で、二塁・三塁・二三塁・一二塁・一三塁・満塁はすべて得点圏に含まれます。走者が一塁だけの場面や無走者の場面は含みません。",
      },
      {
        question: "得点圏打率の計算方法は？",
        answer:
          "得点圏打率 = 得点圏での安打数 ÷ 得点圏での打数 で計算します。たとえば得点圏で40打数12安打なら、12 ÷ 40 = .300 です。打数は通常の打率と同じく、四球・死球・犠打・犠飛・打撃妨害を除いた数を使います。",
      },
      {
        question: "良い得点圏打率の目安は？",
        answer:
          "プロ野球（NPB）のリーグ全体はおおむね.245〜.260で、通常の打率とほぼ同水準です。個人では.280を超えるとリーグ平均より上、.300以上で勝負強い打者、.350以上でリーグ上位、.200未満はチャンスで結果が出ていない状態が目安になります。",
      },
      {
        question: "高校野球の得点圏打率の目安は？",
        answer:
          "高校野球は金属バットの影響で全体に打率が高く出るため、プロの目安よりやや高めに見るのが実態に合います。.350前後で勝負強い打者、.400を超えるとチームの中軸として頼れる存在といえます。ただし試合数が少なく打数も限られるため、数字の上下は大きくなります。",
      },
      {
        question: "得点圏打率と通常の打率の違いは？",
        answer:
          "計算式は同じで、対象とする打席の範囲だけが違います。通常の打率はすべての打数が対象、得点圏打率は二塁・三塁に走者がいる場面の打数だけが対象です。両方を比べると、チャンスでの成績が普段と比べて上振れているか下振れているかが分かります。",
      },
      {
        question: "得点圏打率が高い打者は勝負強いと言えますか？",
        answer:
          "1シーズン分の数字だけで判断するのは危険です。得点圏の打数は全打数の2〜3割程度しかなく、単年の得点圏打率と翌年の得点圏打率の相関は小さいとされています。複数シーズンの傾向として見るか、通常の打率やOPSと併せて評価するのが適切です。",
      },
    ],
    relatedSlugs: ["batting-average", "obp", "ops"],
    cta: {
      heading: "得点圏打率を記録して、チャンスでの打撃を数値で確認しよう",
      body: "BUZZ BASEアプリなら試合結果を入力するだけで得点圏打率を含む全打撃指標を自動算出。チームメイトとランキング形式で成績を共有できます。完全無料。",
    },
  },
};
