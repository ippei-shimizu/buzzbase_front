  ...
  "risp-batting-average": {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "プロ野球（NPB）のリーグ全体はおおむね.250〜.260で、通常の打率とほぼ同水準です。個人では.300以上で勝負強い打者、.350以上でリーグ上位、.200未満はチャンスで結果が出ていない状態が目安になります。",
      },
      {
      ...
      },
      {
        ...
        answer:
          "1シーズン分の数字だけで判断するのは危険です。得点圏の打数は全打数の2〜3割程度しかなく、ある年の得点圏打率は翌年にほとんど引き継がれないことが知られています。複数シーズンの傾向として見るか、通常の打率やOPSと併せて評価するのが適切です。",
      },
    ],
