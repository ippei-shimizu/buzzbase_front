...
const faqItems = [
  {
    ...
    answer:
      "NPB（日本プロ野球）では 3.50 前後がリーグ平均で、3.00 を下回ると「優秀」、2.00 を下回ると「エース級」と言える水準です。1.00 台で安定すると首位打者ならぬ最優秀防御率タイトル候補のレベルです。",
  },
  {
      ...
      <section className="mt-10">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-zinc-700 bg-zinc-800/50 px-5 py-4">
            ...
            <p className="text-sm text-zinc-300 leading-6 mt-2">
              NPB のリーグ平均が概ね 3.30〜3.70 の範囲なので、3.00
              台前半なら平均以上、後半でリーグ平均水準。先発ローテーション維持のラインです。
            </p>
          </div>
          <div className="rounded-lg border border-zinc-700 bg-zinc-800/50 px-5 py-4">
            <p className="font-bold text-zinc-200">
