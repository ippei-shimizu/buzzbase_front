...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "OPS .800はNPB（日本プロ野球）のリーグ平均（おおむね.700前後）を1割以上上回る数値で、レギュラー上位〜クリーンアップを任される好打者の目安です。MLBでもAll-Star候補ラインに入る水準といえます。",
  },
  {
    question: "OPS .700は平均ですか？",
    answer:
      "NPBのリーグ平均OPSは年度によりますがおおむね.680〜.720の範囲で推移しており、.700はちょうど平均水準です。レギュラー定着の最低ラインとして語られることが多く、.700を超えてくると安定したレギュラーといえます。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "リーグ平均はどちらもおおむね.700前後で大きな差はありません。ただしMLBの方が長打率（SLG）が出やすい傾向があり、トップ選手のOPSはやや高めに出ることがあります。基準値（.800で優秀／.900で強打者／1.000超えで超一流）は両リーグで概ね共通して使えます。",
  },
];
    ...
    <>
      ...
      <section id="meaning" className="mt-10">
        ...
        <p className="text-sm text-zinc-300 leading-6 mt-3">
          NPB（日本プロ野球）やMLB（メジャーリーグ）のデータ分析においても、打者の貢献度を測る基本指標として広く活用されています。NPBとMLBではリーグ平均がいずれも.700前後で、評価基準（.800で優秀／.900で強打者／1.000超えで超一流）も概ね共通して通用します。
        </p>
      </section>
