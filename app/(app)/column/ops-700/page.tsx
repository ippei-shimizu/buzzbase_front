...
const faqItems = [
  {
    ...
    answer:
      "歴史的に NPB のリーグ平均 OPS は .700 前後で推移してきましたが、近年（2021〜2023）は .660〜.700 のレンジに下がっています。そのため .700 は「リーグ平均より少し上」に位置する、レギュラー定着の目安として語られるラインです。",
  },
  {
  ...
  return (
    <>
      ...
      <p className="text-sm text-zinc-300 leading-6 mt-4">
        OPS <strong>.700</strong> は歴史的に NPB・MLB
        のリーグ平均ラインとされてきた数値です。直近の NPB は .660〜.700
        のレンジに低下しており、.700
        は「リーグ平均よりやや上」の位置づけですが、依然として
        <strong>レギュラー定着の目安</strong>として語られる水準です。
      </p>

      <section className="mt-8">
        <h2 className="text-xl font-bold mb-3">プロ野球での OPS .700</h2>
        <p className="text-sm text-zinc-300 leading-6">
          歴史的には NPB のリーグ平均が .700 前後とされてきたため、.700 は
          <strong>レギュラー定着の目安</strong>
          として扱われてきました。直近の NPB は .660〜.700
          まで低下しているため、.700
