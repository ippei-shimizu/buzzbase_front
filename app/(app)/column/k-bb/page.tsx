...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "K/BB は奪三振と与四球の比率で、投球回の情報を含みません。K/9 は 9 イニングあたりの奪三振数、BB/9 は 9 イニングあたりの与四球数で、それぞれ絶対数を示します。K/BB が同じ 3.00 でも、K/9 が 9.00 の奪三振型と 5.00 の打たせて取る型では投球スタイルが異なります。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "ストライクゾーンで勝負できる制球力と、追い込んでから仕留める決め球を持っています。四球で走者を溜めないため、ピンチを自ら招くことが少なく、計算しやすい投手として先発ローテーションや抑えを任されやすい傾向があります。",
  },
];
