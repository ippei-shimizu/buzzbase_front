...
const faqItems = [
  {
    ...
    answer:
      "NPB のリーグ平均防御率は年により 2.76〜4.10 のレンジで変動しますが、概ね 3.50 前後が目安。3.00 台前半は「平均より良い」、3.50 前後で「リーグ平均」、3.50 台後半 〜 3.99 で「平均よりやや下」が目安です。",
  },
  {
  ...
  return (
    <>
      ...
      <p className="text-sm text-zinc-300 leading-6 mt-4">
        ...
        のリーグ平均ラインです。リーグ平均防御率は年により 2.76〜4.10
        のレンジで変動しますが、概ね 3.50 前後が目安。3.00
        台は「先発ローテーション中軸の標準レベル」、
