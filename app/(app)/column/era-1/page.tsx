    ...
    <>
      ...
      <section className="mt-8">
        ...
        <ul className="text-sm text-zinc-300 leading-6 list-disc ml-5 space-y-1">
          <li>
            村山実（1970 年・阪神）: 0.98 — 戦後唯一の規定到達者シーズン0点台
          </li>
          <li>稲尾和久（1956 年・西鉄）: 1.06 — 新人王、21勝6敗</li>
          <li>金田正一（1958 年・国鉄）: 1.30 — 31勝14敗・最多勝</li>
          <li>斉藤雅樹（1989 年・巨人）: 1.62 — 20勝7敗・沢村賞</li>
          <li>
            伊藤智仁（1993 年・ヤクルト）: 0.91 — 新人王 (前半戦のみ・故障)
          </li>
          <li>山本由伸（2021 年・オリックス）: 1.39 — 18勝5敗・MVP・沢村賞</li>
        </ul>
      </section>
