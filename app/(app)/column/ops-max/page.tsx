  ...
  return (
    <>
      ...
      <p className="text-sm text-zinc-300 leading-6 mt-4">
        ...
        MLB の歴代最高が
        <strong>1.422（バリー・ボンズ 2004 年）</strong>
        、NPB の歴代最高が <strong>1.293（王貞治 1974 年）</strong>{" "}
        で、これが事実上の天井になります。
      </p>
      ...
      <section className="mt-8">
        ...
        <ul className="text-sm text-zinc-300 leading-6 list-disc ml-5 space-y-1">
          ...
          <li>ベーブ・ルース（1920年）: 1.379</li>
          <li>バリー・ボンズ（2001年）: 1.379</li>
          <li>ベーブ・ルース（1921年）: 1.359</li>
          <li>ベーブ・ルース（1923年）: 1.309</li>
      ...
      <section className="mt-8">
        ...
        <ul className="text-sm text-zinc-300 leading-6 list-disc ml-5 space-y-1">
          ...
          <li>ランディ・バース（1986年）: 1.258</li>
          <li>王貞治（1973年）: 1.255</li>
          <li>落合博満（1985年）: 1.244</li>
