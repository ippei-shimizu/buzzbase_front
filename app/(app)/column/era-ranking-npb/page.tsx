...
const historicalRanking: RankingRow[] = [
  ...
  },
  {
    ...
    year: "1958",
    era: "1.30",
    note: "国鉄スワローズ (31勝14敗・最多勝・最優秀防御率)",
  },
  {
    rank: 4,
    player: "斉藤 雅樹",
...
const notableSeasons = [
  {
    ...
    note: "0.91 — 新人王、肘の故障で短期間ながら衝撃の数字 (7勝2敗)",
  },
  {
    label: "山本由伸（2021, オリックス）",
    note: "1.39 — 沢村賞・MVP、18勝5敗・206奪三振の投手4冠",
  },
  {
    label: "江夏豊（1968, 阪神）",
    note: "2.13 → 翌 1969 年 1.55 へ — シーズン 401 奪三振 (25勝12敗)",
  },
  {
    label: "村田兆治（1981, ロッテ）",
    note: "19勝で最多勝獲得 — ERA 自体は 2 点台だが、ロッテエース全盛期を代表するシーズン",
  },
  {
    label: "杉浦忠（1958, 南海）",
    note: "2.05 — 新人王 (27勝12敗)",
  },
  {
    label: "前田健太（2010, 広島）",
    note: "2.21 — 沢村賞・最多勝・最優秀防御率・最多奪三振の三冠 (15勝8敗)",
  },
];
