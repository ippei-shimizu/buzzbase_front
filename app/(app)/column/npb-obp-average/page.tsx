...
const averageHistory: AverageRow[] = [
  { year: "2018", central: ".325", pacific: ".319" },
  { year: "2019", central: ".322", pacific: ".316" },
  {
    year: "2020",
    central: ".318",
    pacific: ".310",
  ...
  { year: "2021", central: ".311", pacific: ".305" },
  { year: "2022", central: ".305", pacific: ".302" },
  { year: "2023", central: ".300", pacific: ".300" },
];
...
const faqItems = [
  {
    ...
    answer:
      "近年は .300〜.325 のレンジで推移しています。2018 年は両リーグとも .320 前後でしたが、2023 年には両リーグとも .300 前後まで低下しており、投高打低のトレンドが続いています。",
  },
  {
    question: "リーグ平均と最高出塁率タイトル獲得ラインの差は？",
    answer:
      "近年の最高出塁率タイトル獲得ラインは .400 前後で、リーグ平均（.300〜.325）から +0.075〜+0.100 のレンジ。.400 を超えるシーズンは各球団に 1 人いるかどうかの貴重な数値です。",
  },
  {
    question: "セ・パで出塁率の傾向は違う？",
    answer:
      "近年（2018〜2023）はセ・リーグの方がパ・リーグよりわずかに高い傾向でしたが、その差は .003〜.008 程度。2023 年はほぼ同値となっており、DH 制によるパ・リーグの優位性は近年薄まっています。",
  },
];
  ...
  return (
    <>
      ...
      <p className="mt-4 text-sm text-zinc-300 leading-6">
        ...
        にあります。2018 年は両リーグとも .320 前後でしたが、2023
        年には両リーグとも <strong>.300 前後</strong>
      ...
      <section className="mt-8">
        ...
        <p className="text-sm text-zinc-300 leading-6">
          ...
          .003〜.008 程度。2023 年は両リーグとも約 .300 で同水準でした。DH
          制によるパ・リーグ優位という一般論は、年度によっては当てはまらないことが増えています。
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <p className="text-sm text-zinc-300 leading-6">
          リーグ平均 .300〜.325 に対して、最高出塁率タイトルを獲得する打者は概ね{" "}
          <strong>.400 前後</strong> をマーク。リーグ平均から +0.075〜+0.100
