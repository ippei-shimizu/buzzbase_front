...
const averageHistory: AverageRow[] = [
  { year: "2018", central: ".414", pacific: ".399" },
  { year: "2019", central: ".406", pacific: ".393" },
  {
    year: "2020",
    central: ".405",
    pacific: ".377",
  ...
  { year: "2021", central: ".396", pacific: ".369" },
  { year: "2022", central: ".370", pacific: ".358" },
  { year: "2023", central: ".362", pacific: ".354" },
];
  ...
  return (
    <>
      ...
      <p className="mt-4 text-sm text-zinc-300 leading-6">
        ...
        にあります。2018 年はセ・リーグ .414 / パ・リーグ .399 でしたが、2023
        年には両リーグとも <strong>.354〜.362</strong>
      ...
      <section className="mt-8">
        ...
        <p className="text-sm text-zinc-300 leading-6">
          2018〜2023 はセ・リーグの方がパ・リーグよりやや高い傾向で、差は概ね
          .015〜.030 程度。DH
          制を採用するパ・リーグが押し上げられるという一般論は、近年の NPB
          では当てはまっていません。
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <p className="text-sm text-zinc-300 leading-6">
          現代のリーグ平均が .350〜.420 に対して、歴代上位（王貞治 1974 = .761 /
